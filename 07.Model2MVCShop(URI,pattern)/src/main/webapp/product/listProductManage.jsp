...
<form name="detailForm" action="/product/listProductManage" method="post">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	...
	<tr class="ct_list_pop">
		...
		<c:if test = "${product.proTranCode=='000'}">
			...
			<a href="/purchase/updateTranCodeByProd?ProTranCode=${product.proTranCode}&tranNo=${product.tranNo}">배송하기</a>
